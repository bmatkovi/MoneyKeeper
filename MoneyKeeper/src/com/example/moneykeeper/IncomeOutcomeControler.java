			...
			button.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					prikaz.setOnClickListener(new OnClickListener() {
						...
						//	new Delete().from(Racun.class).execute();
							// new Delete().from(Transakcija.class).execute();
							List<Transakcija> trans = Transakcija.getTransakcions();							
							StringBuilder builder = new StringBuilder();
							for (Transakcija transakcija : trans) {
					...
					spremiButton.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							String datum = ((EditText) dialog
								...
								DigitalClock dc = (DigitalClock) dialog.findViewById(R.id.vrijemeTroska);
							...
							if (iznos != 0) {
								...
								for (Racun racun : rac) {
									racun.iznos = racun.iznos + transakcija.iznos;
									racun.save();
								}
